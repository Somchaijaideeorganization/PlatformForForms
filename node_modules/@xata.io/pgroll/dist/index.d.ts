...
declare const OpCreateIndexDefinition: z.ZodObject<{
    ...
    storage_parameters: z.ZodOptional<z.ZodString>;
    unique: z.ZodOptional<z.ZodBoolean>;
}, "strip", z.ZodTypeAny, {
    name: string;
    table: string;
    ...
    storage_parameters?: string | undefined;
}, {
    name: string;
    table: string;
    columns: string[];
    ...
    readonly $defs: {
        ...
        readonly OpCreateIndex: {
            ...
            readonly properties: {
                ...
                readonly predicate: {
                    readonly description: "Conditional expression for defining a partial index";
                    readonly type: "string";
                };
                readonly method: {
                    readonly description: "Index method to use for the index: btree, hash, gist, spgist, gin, brin";
                    readonly type: "string";
                    readonly enum: readonly ["btree", "hash", "gist", "spgist", "gin", "brin"];
                };
                readonly storage_parameters: {
                    readonly description: "Storage parameters for the index";
                    readonly type: "string";
                };
                readonly unique: {
                    readonly description: "Indicates if the index is unique";
                    readonly type: "boolean";
                };
            };
        ...
        readonly OpDropConstraint: {
            ...
            readonly required: readonly ["down", "name", "table", "up"];
            readonly type: "object";
        };
