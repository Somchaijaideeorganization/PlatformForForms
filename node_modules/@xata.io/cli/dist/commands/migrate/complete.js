...
class MigrateComplete extends BaseCommand {
    async run() {
        ...
        this.log(`Migration complete started with Job ID ${chalk.cyan(migrationJob.jobID)}. Please use the "${chalk.gray(`xata migration status ${branch}`)}" command to check its status`);
        this.log();
    }
}
_a = MigrateComplete;
MigrateComplete.description = 'Complete an active migration';
MigrateComplete.examples = [];
MigrateComplete.flags = {
    ..._a.commonFlags,
    ..._a.databaseURLFlag
};
MigrateComplete.args = {
